...
(function () {
    ...
    var path, fs, shim, uglify, coffee, loadedFiles,
        ...
        readFile, loadFiles, joinFiles, minify, scrunch,
        fileIn, fileOut;
    ...
    joinFiles = function (init) {
        ...
        for (path in loadedFiles) {
            if (loadedFiles.hasOwnProperty(path)) {
                ...
                output += file.contents.replace(/^/mg, '      ');
    ...
    scrunch = function (fileIn, fileOut, fn) {
        var contents;
    ...
    if (module.parent === null) {
        ...
        if (fileOut > -1) {
            ...
            scrunch(fileIn, fileOut);
        } else {
            console.log(minify(scrunch(fileIn)));
        }
    }
